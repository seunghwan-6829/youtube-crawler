      ...
      <nav className='navbar fixed top-0 left-0 right-0 z-50'>
        <div className='max-w-6xl mx-auto px-6 py-4 flex justify-between items-center'>
          ...
          <div className='flex items-center gap-6'>
            {isAdmin && (
              <Link href='/admin' className='text-orange-500 hover:text-orange-600 font-medium transition-colors'>
                愿由ъ옄
              </Link>
            )}
            ...
            {videos.map((video) => (
              <div key={video.id} className='card flex gap-4 hover:shadow-lg transition-shadow'>
                ...
                <a
                  ...
                  className='btn-primary text-sm py-2 px-4 self-center flex-shrink-0'
                >
                  蹂닿린
                </a>
              </div>
