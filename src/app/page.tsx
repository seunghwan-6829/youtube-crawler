        ...
        <div className='max-w-6xl mx-auto px-6'>
          <div className='text-center py-20'>
            ...
            <h1 className='text-5xl md:text-6xl font-bold mb-6 leading-tight'>
              ?좏뒠釉??곗씠?곕?<br/>
              <span className='gradient-text'>?쎄퀬 鍮좊Ⅴ寃?/span> ?섏쭛?섏꽭??            </h1>
            <p className='text-xl text-gray-600 mb-10 max-w-2xl mx-auto'>
              由щ????щ·?щ줈 ?좏뒠釉??곸긽 硫뷀??곗씠?곕? ?먯돺寃?寃?됲븯怨?br/>
              遺꾩꽍?섏뿬 ?몄궗?댄듃瑜??살쑝?몄슂.
            </p>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8 mt-16'>
            <div className='card hover:shadow-xl transition-shadow'>
              ...
              <p className='text-gray-500'>?ㅼ썙?쒕줈 ?좏뒠釉??곸긽???ㅼ떆媛꾩쑝濡?寃?됲븯怨?寃곌낵瑜??뺤씤?섏꽭??</p>
            </div>
            <div className='card hover:shadow-xl transition-shadow'>
              ...
              <p className='text-gray-500'>議고쉶?? 醫뗭븘?? ?볤? ?????곸긽??紐⑤뱺 硫뷀??곗씠?곕? ?섏쭛?섏꽭??</p>
            </div>
            <div className='card hover:shadow-xl transition-shadow'>
              ...
              <p className='text-gray-500'>?섏쭛???곗씠?곕? 湲곕컲?쇰줈 ?몃젋?쒕? 遺꾩꽍?섍퀬 ?몄궗?댄듃瑜??살쑝?몄슂.</p>
            </div>
          </div>
        </div>
      </main>
